      ...
      <div className="card p-6 print:shadow-none print:border-none" id="statement">
        ...
        <div className="flex items-start justify-between pb-5 border-b border-gray-200 mb-5">
          ...
          <div className="text-right">
            <p className="text-xs font-bold text-indigo-700 uppercase tracking-widest">GuruFinance</p>
        ...
        <div className="mt-6 pt-4 border-t border-gray-200 text-center">
          <p className="text-xs text-gray-400">
            Generated by GuruFinance - Smart Loan & Interest Management on {statementDate}.
          </p>
        </div>
      </div>
